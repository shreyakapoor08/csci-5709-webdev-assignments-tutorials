  ...
  return (
    <Grid container component="main" sx={{ height: "100vh" }}>
      ...
      >
        ...
        >
          Register With Us!
          <img src="https://cloud-image-upload.s3.amazonaws.com/images/b1c91a92-41d5-4c2a-b244-856ecfa280d0-p2.jpg" alt="Registration Image" style={{ display: "block", marginTop: "20px", width: "80%", maxWidth: "500px" }} />
        </Typography>
      </Grid>
